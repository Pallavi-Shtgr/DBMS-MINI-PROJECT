<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($picError === 0) {
            $picNameNew = $productName . "_" . $_SESSION['id'] . ".jpeg"; // You can use a consistent extension like PNG
            ...
            if (move_uploaded_file($picTmpName, $picDestination)) {
                ...
                $_SESSION['message'] = "There was an error in moving the uploaded file! Please Try again!";
            }
        } else {
            $_SESSION['message'] = "There was an error in uploading your product image! Please Try again!";
        }
