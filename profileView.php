<?php
    ...
    if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] != 1 || !isset($_SESSION['Username']) || !isset($_SESSION['picName']) || !isset($_SESSION['Name']) || !isset($_SESSION['Rating']) || !isset($_SESSION['Email']) || !isset($_SESSION['Mobile']) || !isset($_SESSION['Addr'])) {
...
<?php
    require 'menu.php'; // Assuming menu.php contains the menu HTML
?>
...
<section id="one" class="wrapper style1 align">
    <div class="inner">
        <div class="box">
            <header>
                <center>
                    <span><img src="images/profileImages/<?php echo $_SESSION['picName'] . '?' . mt_rand(); ?>" class="image-circle" class="img-responsive" height="200%"></span>
                    <br>
